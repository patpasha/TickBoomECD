...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="relative py-24 px-6 lg:px-12 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Section Header */}
        <div className="text-center mb-16">
          <div className="inline-block px-4 py-2 bg-[rgba(0,255,65,0.1)] border border-[rgba(0,255,65,0.3)] mb-6">
            <span className="text-[#00FF41] text-sm uppercase tracking-wider">The Process</span>
          </div>
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            How <span className="text-[#00FFD1] glow-text">TickBoom</span> Works
          </h2>
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-24 left-[60%] w-[80%] h-0.5 bg-gradient-to-r from-[rgba(0,255,209,0.5)] to-transparent"></div>
              )}
              ...
              <div className="cyber-card p-8 h-full relative group">
                {/* Number Badge */}
                <div 
                  className="absolute -top-4 -right-4 w-16 h-16 flex items-center justify-center border-2 bg-black font-bold text-2xl"
                ...
                {/* Icon */}
                <div 
                  className="w-16 h-16 mb-6 flex items-center justify-center border relative"
        ...
        <div className="mt-24 cyber-card p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-3xl font-bold mb-6">
              The <span className="text-[#FF0055]">Evil</span> Philosophy
            </h3>
            <p className="text-xl text-[rgba(255,255,255,0.85)] max-w-4xl mx-auto leading-relaxed">
              ...
              <span className="text-[#00FFD1]"> No excuses. Only results.</span>
            </p>
          </div>
        </div>
      </div>
