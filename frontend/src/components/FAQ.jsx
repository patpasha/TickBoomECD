...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "No. That's the point. Real life doesn't have a pause button. TickBoom creates the same pressure as real deadlines. If you set a commitment, you commit. This is what makes TickBoom effective where other apps fail."
    },
    {
